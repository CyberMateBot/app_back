...
type UseCase interface {
	...
	ResetAdminSubscriptionPlans(ctx context.Context) (ucModels.AdminListSubscriptionPlansOutput, error)
	...
	ResetAdminCoinPacks(ctx context.Context) (ucModels.AdminListCoinPacksOutput, error)
