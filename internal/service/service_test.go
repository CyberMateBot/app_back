...
func (f *fakeUC) GetUser(ctx context.Context, input ucModels.GetUserInput) (ucModels.GetUserOutput, error) {
	if input.UserID == 7 {
		return ucModels.GetUserOutput{Data: ucModels.User{ID: 7, Name: "N", Surname: "S"}}, nil
	}
...
func (f *fakeUC) ResetAdminSubscriptionPlans(ctx context.Context) (ucModels.AdminListSubscriptionPlansOutput, error) {
	return ucModels.AdminListSubscriptionPlansOutput{}, errors.New("not impl")
}
...
func (f *fakeUC) ResetAdminCoinPacks(ctx context.Context) (ucModels.AdminListCoinPacksOutput, error) {
	return ucModels.AdminListCoinPacksOutput{}, errors.New("not impl")
}
...
func (f *fakeUC) StartCheckout(ctx context.Context, input ucModels.StartCheckoutInput) (ucModels.StartCheckoutOutput, error) {
...
func (f *fakeUC) VerifyAdminToken(ctx context.Context, adminID, tokenVersion int64) error {
	return errors.New("not impl")
}
